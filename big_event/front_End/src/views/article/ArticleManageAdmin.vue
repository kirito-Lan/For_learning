...
import {
  articleAddService,
  articleCategoryListServiceV2,
  articleListService, articleSelectService
} from '@/api/article.js'
...
<template>
      ...
      <el-table-column label="操作" width="100">
        <template #default="{ row }">
          <el-button :icon="Edit" circle plain type="primary"
                     @click="visibleDrawer=true;EditArticle(row)"></el-button>
  ...
  <!-- 抽屉 用于添加文章-->
  <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%" @close="flag=false">
    <!-- 添加文章表单 -->
    <el-form :model="articleModel" label-width="100px">
      ...
      <el-form-item>
        <template v-if="flag">
          ...
          <el-button type="info" @click="addArticle('草稿')">存为草稿</el-button>
        </template>
        <!--flag===false 是修改文章-->
        <template v-if="!flag">
          <el-button type="primary" @click="updateArticle('已发布')">更新文章</el-button>
          <el-button type="info" @click="updateArticle('草稿')">修改为草稿</el-button>
        </template>
      </el-form-item>
    </el-form>
